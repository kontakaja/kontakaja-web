                    ...
                    <div class="card__wrapper">
                        <div class="card__container">
                            <div class="card__body">
                                <div class="contact-card__avatar">
                                    <svg viewBox="0 0 252 272" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <defs>
                                            ...
                                            <pattern id="imagePattern0"
                                                patternContentUnits="objectBoundingBox" width="1"
                                                height="1">
                                                <use xlink:href="#avatarImage0"
                                ...
                                <div class="contact-card__label"><span
                                        class="label label--primary">Teman</span>
                                </div>
                    ...
                    <div class="card__wrapper">
                        <div class="card__container">
                            <div class="card__body">
                                ...
                                <div class="contact-card__label"><span
                                        class="label label--primary">Keluarga</span>
                                </div>
